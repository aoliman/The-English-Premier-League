...
public class HomeDIContainer : SharedContainer {
    static let competitionsMatchesServiceDataSource = Factory<CompetitionsMatchesServiceDataSourceProtocol> (scope: .shared,factory: {CompetitionsMatchesDataSource() })
